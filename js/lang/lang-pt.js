get_string = {
	...
	theory_paragraph_32_title: "Respresentação",
	theory_paragraph_32: "Os dados necessários para o algoritmo podem ser representados em uma matriz, aonde cada linha está associada a um processo, cada coluna está associada a um recurso e os elementos são a quantidade do recurso alocada ao processo.",
	theory_paragraph_33_def1_title: "Hipóteses e entrada",
	theory_paragraph_33_def2_title: "Passo 1",
	theory_paragraph_33_def3_title: "Passo 2",
	theory_paragraph_33_def4_title: "Passo 3",
	theory_paragraph_33_def1: "O algoritmo assume que o sistema tem a informação da quantidade máxima de cada recurso a ser solicitada por cada processo. A entrada é uma solicitação de recursos. Sempre que ocorre uma solicitação, os passos abaixo são executados.",
	theory_paragraph_33_def2: "Buscar um processo (linha) cuja demanda por cada recurso seja menor ou igual à disponiblidade do recurso. Se nenhum processo for encontrado, temos um estado inseguro e poderá ocorrer um impasse, portanto, a solicitação é negada.",
	theory_paragraph_33_def3: "Assumir que todos os recursos solicitados pelo proceso encontrado são fornecidos a ele e que é executado até sua conclusão. Os recursos desse processo são então liberados, para serem utilizados por outros processos.",
	theory_paragraph_33_def4: "Repetir os passos anteriores até que todos os processos tenham sido executados até a conclusão ou que não seja possível fornecer recursos para que algum dos processos execute. Se todos os processos foram executados, o estado é seguro e os recursos podem ser alocados como solicitado. Caso contrário, o estado é inseguro e a solicitação não será atendida.",
	theory_paragraph_34_title: "Considerações finais",
