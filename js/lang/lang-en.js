get_string = {
	...
	theory_title_3: "The banker's algorithm",
	...
	theory_paragraph_2: "If the resources can be allocated in such a way that all processes can be executed to termination, we have a safe state.",
	theory_paragraph_3: "An algorithm created by Dijkstra in 1965. It can be used to prevent deadlocks. Everytime resources are requested, the algorithm checks whether grating the request leads to an unsafe state and if it does, the request is denied.",
