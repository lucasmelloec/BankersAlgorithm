get_string = {
	...
	theory_paragraph_32_def1_title: "Hypothesis and input",
	theory_paragraph_32_def2_title: "Step 1",
	theory_paragraph_32_def3_title: "Step 2",
	theory_paragraph_32_def4_title: "Step 3",
	theory_paragraph_32_def1: "The algorithm assumes that the system has information about the maximum amount of each resource to be required by each process. The input is a request for resources. Whenever there is a new request for resources the steps below are executed.",
	theory_paragraph_32_def2: "Look for a process (row) whose demand for resources is equal or smaller than the availability of that resource. If no process can be found, we have a unsafe state, what may lead to a deadlock.",
	theory_paragraph_32_def3: "Assume that all resources required by a process are provided to that process and it runs to termination. The resources allocated to that process are then freed and can be used by other processes.",
	theory_paragraph_32_def4: "Repeat the previous steps until all processes run to termination or no process can be granted enough resources to run until completion. If all processes have terminated, the state is safe and the resources requested can be granted. Otherwise, the state is unsafe and the request will not be granted.",
	theory_paragraph_33_title: "Final considerations",
	theory_paragraph_33: "While the banker's algorithm is sufficient to avoid deadlocks in theory, in practice the hypothesis is not satisfied in most systems since there is no information regarding the maximum amount of resources that each process will require throughout its execution.",
